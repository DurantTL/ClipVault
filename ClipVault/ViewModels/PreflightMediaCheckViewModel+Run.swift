...
extension PreflightMediaCheckViewModel {
  func run(
    ...
    let scanLocations = preflightLocations(
    ...
    message = "Preflight complete: \(summary.newCount) new, \(summary.alreadyImportedCount) already imported, \(summary.reviewCount) need review."
  }
